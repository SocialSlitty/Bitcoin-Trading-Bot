...
def run_simulation(df, config: SimConfig = None):
    ...
    # Optimization: Pre-calculate date strings to avoid expensive datetime formatting in the loop
    # Using np.datetime_as_string is ~10x faster than pd.Timestamp(...).strftime inside the loop
