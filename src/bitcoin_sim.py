...
def run_simulation(df, config: SimConfig = None):
    ...
    # OPTIMIZATION: Pre-calculate date strings outside the loop (~7x speedup for formatting)
    # This avoids repeated expensive calls to pd.Timestamp().strftime() inside the loop
